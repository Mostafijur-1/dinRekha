    ...
    <main>
      ...
      <section className="trust-section">
        <div className="page-width trust-grid">
          ...
          <p>
            Google দিয়ে নিরাপদ প্রবেশ এবং মালিকভিত্তিক অনুমতি। শুধু আপনার সক্রিয়
            সংযোগগুলো ডিফল্ট তথ্য দেখতে পারে; যেকোনো sharing permission আপনি
            আলাদাভাবে বন্ধ করতে পারেন। ব্যক্তিগত Timeline note কখনো share হয় না।
          </p>
          <Link className="button button-primary" href={primaryHref}>
